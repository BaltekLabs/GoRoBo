...
(function($) {
	...
	function init_ED_PageBackground() {
		...
		if ($('#youtube-background').length > 0) {
			var videos = [
				{videoURL: "https://youtu.be/GmcCBDToDtM", showControls:false, containment:'.overlay-video',autoPlay:true, mute:true, startAt:0,opacity:1, loop:false, showYTLogo:false, realfullscreen: true, addRaster:true}
			];
